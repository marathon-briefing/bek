...
STUDENTS = [
    ...
    {"編號": "M26003", "姓名": "張維倫", "email": "1010.888go@gmail.com",
     "日誌": f"{MARATHON_DIR}/M26003-張維倫/M26003-張維倫_馬拉松訓練日誌.xlsx",
     "課表": f"{MARATHON_DIR}/M26003-張維倫/M26003-張維倫_馬拉松課表.xlsx",
     "健康": f"{MARATHON_DIR}/M26003-張維倫/M26003-張維倫_健康紀錄.xlsx"},
...
目前學員晨報系統正在進行優化中，如果信件內容有錯誤或缺漏，請隨時跟教練確認，以免造成課表的誤解，不好意思。另外，也歡迎您提出建議，希望在呈報中還能看到什麼資訊。
